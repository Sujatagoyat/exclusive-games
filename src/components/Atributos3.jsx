...
import Imagebulb from '../assets/png/bulb.png'
import Imagecontact from '../assets/png/contact.png'
import Imagesetting from '../assets/png/setting.png'
import Imagejet from '../assets/png/jetx-1.png'
import Imageslot2 from '../assets/png/slot-img-2.png'
import Imageslot3 from '../assets/png/slot-img-3.png'
import Imageslot4 from '../assets/png/slot-img-4.png'
import Imageslot5 from '../assets/png/slot-img-5.png'
import Imageslot6 from '../assets/png/slot-img-6.png'
...
function Atributos3() {
    return (
        ...
        <section className='my-py bg-img-2 position-relative z-3'>
                    ...
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className='box'>
                            <div className='mx-auto pb-16'>
                                <img className='max-w-100 ' src={Imagebulb} alt="bulb.png" />
                            </div>
                            <p className='sub-heading text-center'>Inteligencia</p>
                            <p className='text max-w-263 text-center'>Comprendemos a la perfección los gustos de las personas y el mundo del gaming.</p>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className='box'>
                            <div className='mx-auto pb-16'>
                                <img className='max-w-100 ' src={Imagecontact} alt="bulb.png" />
                            </div>
                            <p className='sub-heading text-center'>Proactividad</p>
                            <p className='text max-w-263 text-center'>Somos creadores de cambios que exploran nuevas formas de entretenimiento.</p>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className='box'>
                            <div className='mx-auto pb-16'>
                                <img className='max-w-100 ' src={Imagesetting} alt="bulb.png" />
                            </div>
                            <p className='sub-heading text-center'>Innovación</p>
                            <p className='text max-w-263 text-center'>Pensamos fuera de la caja para estar siempre un paso adelante.</p>
                        </div>
                    </div>
            ...
            {/* </section> */}
            {/* <section className='py-5 bg-img-2'> */}
            <div className="container">
                <h2 className='heading text-center pb-16'>Slots</h2>
                <p className='text max-w-904 text-center mx-auto pb-60'>En Exclusive Games, ofrecemos una selección de más de 600 juegos de los principales desarrolladores, como Aristocrat, Amatic, EGT, Novomatic, IGT, Playtech, Igrosoft y Tom Horn. Nuestro equipo trabaja incansablemente para innovar y ampliar nuestra oferta de experiencias, garantizando la máxima seguridad con operaciones protegidas por cifrado SSL de 256 bits.</p>
                <div className="row">
                    <div className='col-lg-4 col-6 position-relative card_hover'>
                        <div className='position-relative black_layer mb-4 '>
                            <img className='w-100 ' src={Imagejet} alt="1slot-img" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='  position-relative cursor_pointer d-inline-flex justify-content-center align-items-center'>
                                <button className='bttn btn-style color-white '>Jugar</button>
                    ...
                    <div className='col-lg-4 col-6 position-relative card_hover'>
                        <div className='position-relative black_layer mb-4 '>
                            <img className='w-100 ' src={Imageslot2} alt="1slot-img" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                    ...
                    <div className='col-lg-4 col-6 position-relative card_hover'>
                        <div className='position-relative black_layer mb-4 '>
                            <img className='w-100 ' src={Imageslot3} alt="slot-img-3.png" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='mt-4  position-relative cursor_pointer d-inline-flex justify-content-center align-items-center'>
                                <button className='bttn btn-style color-white '>Jugar</button>
                    ...
                    <div className='col-lg-4 col-6 position-relative card_hover'>
                        <div className='position-relative black_layer mb-4 '>
                            <img className='w-100 ' src={Imageslot4} alt="slot-img-4.png" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='mt-4  position-relative cursor_pointer d-inline-flex justify-content-center align-items-center'>
                                <button className='bttn btn-style color-white '>Jugar</button>
                    ...
                    <div className='col-lg-4 col-6 position-relative card_hover'>
                        <div className='position-relative black_layer mb-4 '>
                            <img className='w-100 ' src={Imageslot5} alt="slot-img-5.png" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='mt-4  position-relative cursor_pointer d-inline-flex justify-content-center align-items-center'>
                                <button className='bttn btn-style color-white '>Jugar</button>
                    ...
                    <div className='col-lg-4 col-6 position-relative card_hover'>
                        <div className='position-relative black_layer mb-4 '>
                            <img className='w-100 ' src={Imageslot6} alt="slot-img-6.png" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='mt-4  position-relative cursor_pointer d-inline-flex justify-content-center align-items-center'>
                                <button className='bttn btn-style color-white '>Jugar</button>
                ...
                <div className='position-relative   max-w-162 mx-auto '>
                    ...
                    <div className='btn-svg d-lg-block d-none'>
                        <svg width="107" height="28" viewBox="0 0 107 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_2775_7" x1="134.466" y1="25.6913" x2="113.531" y2="-37.3975" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#51C8EF" />
                                    <stop offset="1" stop-color="#7AF57A" />
                                </linearGradient>
                            </defs>
