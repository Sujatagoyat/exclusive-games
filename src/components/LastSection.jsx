                        ...
                        <div className="row mt-4 mt-lg-0">
                            <div className="col-md-4">
                                <ul className='mt-3 mt-lg-0'>
                                    ...
                                    <li className='mb-2'><a className='text color-white div>' href="">Hogar</a></li>
                                    <li className='mb-2' ><a className='text color-white div>' href="">Misión</a></li>
                                    <li className='mb-2' ><a className='text color-white div>' href="">Tragamonedas</a></li>
                                    <li className='mb-2' ><a className='text color-white div>' href="">Por qué elegirnos</a></li>
                                    <li className='mb-2' ><a className='text color-white ' href="">Ofertas</a></li>
                                </ul>
                            </div>
                            <div className="col-md-4">
                                <ul className='mt-3 mt-lg-0'>
                                    <li className='bttn color-white mb-3'>Atención al cliente</li>
                                    <li className='mb-2'><a className='text color-white div>' href="">¿Necesitas ayuda?</a></li>
                                    <li className='mb-2' ><a className='text color-white div>' href="">política de privacidad</a></li>
                                    <li className='mb-2' ><a className='text color-white div>' href="">Términos de servicios</a></li>

                                </ul>
                            </div>
                            <div className="col-md-4">
                                <ul className='mt-3 mt-lg-0'>
                                    <li className='bttn color-white mb-3'>Ponerse en contacto</li>
                                    <li>
                                    ...
                                    <li className='d-flex gap-2 align-items-center'>
                                        ...
                                        <p className='text color-white mb-0'>(101)342-7873</p>
